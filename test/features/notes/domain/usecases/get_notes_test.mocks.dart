...
// in notes_tdd/test/features/notes/domain/usecases/get_notes_test.dart.
...
import 'package:notes_tdd/features/notes/domain/entities/notes.dart' as _i3;
...
class MockBox extends _i1.Mock implements _i2.Box<_i3.Note> {
  @override
  Iterable<_i3.Note> get values => (super.noSuchMethod(
        Invocation.getter(#values),
        returnValue: <_i3.Note>[],
        returnValueForMissingStub: <_i3.Note>[],
      ) as Iterable<_i3.Note>);
  @override
  ...
  @override
  Iterable<_i3.Note> valuesBetween({
    dynamic startKey,
    dynamic endKey,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Note? getAt(int? index) => (super.noSuchMethod(
        Invocation.method(
          #getAt,
          [index],
        ),
  ...
  @override
  Map<dynamic, _i3.Note> toMap() => (super.noSuchMethod(
        Invocation.method(
          #toMap,
          [],
        ),
        returnValue: <dynamic, _i3.Note>{},
        returnValueForMissingStub: <dynamic, _i3.Note>{},
      ) as Map<dynamic, _i3.Note>);
  @override
  ...
  @override
  _i4.Future<void> putAll(Map<dynamic, _i3.Note>? entries) =>
      (super.noSuchMethod(
        Invocation.method(
          #putAll,
          [entries],
  ...
  @override
  _i4.Future<int> add(_i3.Note? value) => (super.noSuchMethod(
        Invocation.method(
          #add,
          [value],
        ),
  ...
  @override
  _i4.Future<Iterable<int>> addAll(Iterable<_i3.Note>? values) =>
      (super.noSuchMethod(
        Invocation.method(
          #addAll,
          [values],
